...
Here is your render loop rewritten to fully leverage the zero-overhead profiling zones.

I have broken down the zones into logical engine stages: Input, Math & Uniform Update, Render Dispatch, and Frame Present. This gives you highly granular insight into exactly where a performance bottleneck is occurring.
The Profiler-Enhanced Render Loop
Scala
